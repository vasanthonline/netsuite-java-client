...
public final class Messages {
    ...
    public static final String GET_INVOICES_FOR_CUSTOMER = "Get invoices for a Customer (Internal ID required)";
    ...
    public static final String INVOICES_FOUND = "The following invoices were found:";
    public static final String SALES_ORDER_WITH_INDEX = "Sales Order #%s:";
    public static final String INVOICE_WITH_INDEX = "Invoice #%s:";
    ...
    public static final String NO_INVOICES_FOUND = "No invoices were found.";
    public static final String NO_INVOICES_WITH_CUSTOMER_FOUND = "No invoices were found for customers with name containing '%s'.";
    ...
    public static final String TAX_TOTAL = "Tax Total";
