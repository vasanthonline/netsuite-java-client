...
public final class PrintUtils {
    ...
    public static void printInvoice(Invoice invoice, boolean isEntityId, int index) {
        printEmptyLine();
        LOG.info(format(INVOICE_WITH_INDEX, index));
        printMap(new Fields(invoice, isEntityId));
